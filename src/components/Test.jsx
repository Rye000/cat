                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        setManualZiwiGrams(Number(e.target.value))
                      }
              ...
              <div className="flex flex-col gap-2 mb-3 bg-gray-50 p-2 rounded-lg">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 p-2 text-base bg-white border border-gray-200 rounded focus:outline-none focus:border-purple-300"
                  />
                  <input
                    type="number"
                    placeholder="kcal"
                    value={newCustomKcal}
                    onChange={(e) => setNewCustomKcal(e.target.value)}
                    className="w-20 p-2 text-base bg-white border border-gray-200 rounded focus:outline-none focus:border-purple-300"
                  />
                </div>
                <div className="flex gap-2">
                  <select
              ...
              <div className="flex items-center gap-4">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full text-3xl font-black text-gray-700 border-b-2 border-blue-100 focus:border-blue-500 outline-none py-1"
                  />
                </div>
